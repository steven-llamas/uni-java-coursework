/*
Other files needed: 1 file, QuoteOptions.java (coursework_5.java)
*/
...
public class QuoteOptionsPane extends HBox
{
    ...
    {
        if (philosophyButton.isSelected())   quote.setText(philosophyQuote);
        else if (carpentryButton.isSelected())  quote.setText(carpentryQuote);
        else   quote.setText(comedyQuote);
    }
}