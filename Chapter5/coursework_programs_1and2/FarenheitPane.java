/*
Other files needed: 1 file, FarenheitConverter.java (coursework_2.java)
*/
...
public class FarenheitPane extends GridPane
{
    private Label result;
    private TextField fahrenheit;
    // Sets up a GUI containing a labeled text field for converting temperatures in Fahrenheit to Celsius.
    ...
    // Computes and displays the converted temperature when the user presses the return key while in the text field.
